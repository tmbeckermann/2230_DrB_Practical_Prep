(() => {
  ...
  "muscleImageCards": [
    {
      ...
      "labeledImages": [
        {
          "image": "assets/pal/muscle-atlas/labeled/trunk-03-m0004a.webp",
          "sourceTitle": "Muscles of the trunk, posterior view",
          "sourceLabel": "Trapezius"
        },
        {
          "image": "assets/pal/muscle-atlas/labeled/trunk-04-m0004b.webp",
          "sourceTitle": "Muscles of the trunk, posterior view",
          "sourceLabel": "Trapezius"
        },
        {
          "image": "assets/pal/muscle-atlas/labeled/head-neck-01-m0002.webp",
          "sourceTitle": "Superficial muscles of the head and neck, anterolateral view",
          "sourceLabel": "Trapezius"
        },
        {
          "image": "assets/pal/muscle-atlas/labeled/head-neck-08-m3022.webp",
      ...
      "sourceTitles": [
        ...
        "Muscles of the trunk, posterior view",
        "Superficial muscles of the head and neck, anterolateral view",
        "Superficial muscles of head and neck, posterior view"
      ],
      "sourceLabels": [
        "Trapezius"
      ],
    ...
    {
      "id": "muscle-atlas-levator-scapulae",
      ...
      "labeledImages": [
        ...
        {
          "image": "assets/pal/muscle-atlas/labeled/head-neck-06-m3021b.webp",
      ...
      "sourceTitles": [
        "Muscles of the trunk, posterior view",
        "Superficial muscles of head and neck, posterior view",
        "Deep muscles of the head and neck, left lateral view"
      ],
      "sourceLabels": [
        "Levator scapulae"
      ],
    ...
    {
      "id": "muscle-atlas-rhomboid-minor",
    ...
    {
      "id": "muscle-atlas-rhomboid-major",
    ...
    },
    {
      ...
      "labeledImages": [
        {
          "image": "assets/pal/muscle-atlas/labeled/trunk-05-m3023.webp",
          "sourceTitle": "Muscles of the trunk, lateral view",
          "sourceLabel": "Subclavius"
        },
        {
          "image": "assets/pal/muscle-atlas/labeled/trunk-01-m0003a.webp",
          "sourceTitle": "Muscles of the trunk, anterior view",
          "sourceLabel": "Subclavius"
        },
        {
          "image": "assets/pal/muscle-atlas/labeled/upper-limb-01-m0005.webp",
          "sourceTitle": "Muscles of the scapula and arm, anterior view, left side",
          "sourceLabel": "Subclavius (cut)"
        }
      ],
      "sourceTitles": [
        "Muscles of the trunk, lateral view",
        "Muscles of the trunk, anterior view",
        "Muscles of the scapula and arm, anterior view, left side"
      ],
      "sourceLabels": [
        "Subclavius",
        "Subclavius (cut)"
    ...
    {
      "id": "muscle-atlas-pectoralis-minor",
      ...
      "labeledImages": [
        ...
        {
          "image": "assets/pal/muscle-atlas/labeled/trunk-06-m3024.webp",
          "sourceTitle": "Muscles of the trunk, anterior view",
          "sourceLabel": "Pectoralis minor"
        },
        {
    ...
    {
      "id": "muscle-atlas-serratus-anterior",
    ...
    },
    {
      ...
      "labeledImages": [
        ...
        {
          "image": "assets/pal/muscle-atlas/labeled/trunk-09-m3026.webp",
          "sourceTitle": "Muscles of the trunk, posterior view",
          "sourceLabel": "Supraspinatus"
        }
      ],
    ...
    },
    {
      ...
      "labeledImages": [
        ...
        {
          "image": "assets/pal/muscle-atlas/labeled/trunk-08-m3025b.webp",
          "sourceTitle": "Muscles of the trunk, right lateral view",
          "sourceLabel": "Teres minor"
        },
        {
          "image": "assets/pal/muscle-atlas/labeled/upper-limb-02-m0006.webp",
      ...
      "sourceTitles": [
        "Muscles of the trunk, posterior view",
        "Muscles of the trunk, posterior view",
        "Muscles of the trunk, right lateral view",
        "Superficial muscles of the scapula and arm, posterior view, left side"
      ],
      "sourceLabels": [
        "Teres minor"
      ],
    ...
    {
      "id": "muscle-atlas-pectoralis-major",
      ...
      "labeledImages": [
        ...
        {
          "image": "assets/pal/muscle-atlas/labeled/trunk-07-m3025a.webp",
      ...
      "sourceTitles": [
        "Muscles of the trunk, anterior view",
        "Muscles of the trunk, anterior view",
        "Muscles of the trunk, left lateral view",
        "Muscles of the scapula and arm, anterior view, left side"
      ],
      "sourceLabels": [
        "Pectoralis major",
    ...
    {
      "id": "muscle-atlas-triceps-brachii",
    ...
    {
      "id": "muscle-atlas-latissimus-dorsi",
    ...
    {
      "id": "muscle-atlas-biceps-brachii",
    ...
    {
      "id": "muscle-atlas-brachioradialis",
      ...
      "labeledImages": [
        {
          "image": "assets/pal/muscle-atlas/labeled/upper-limb-05-m0009.webp",
          "sourceTitle": "Superficial muscles of the forearm and hand, posterior view, left side",
          "sourceLabel": "Brachioradialis"
        },
        {
          "image": "assets/pal/muscle-atlas/labeled/upper-limb-03-m0007.webp",
          "sourceTitle": "Superficial muscles of the forearm, anterior view, left side",
          "sourceLabel": "Brachioradialis"
        }
      ],
      "sourceTitles": [
        "Superficial muscles of the forearm and hand, posterior view, left side",
        "Superficial muscles of the forearm, anterior view, left side"
      ],
      "sourceLabels": [
        "Brachioradialis"
      ],
    ...
    {
      "id": "muscle-atlas-pronator-teres",
      ...
      "labeledImages": [
        ...
        {
          "image": "assets/pal/muscle-atlas/labeled/upper-limb-04-m0008.webp",
      ...
      "sourceTitles": [
        "Superficial muscles of the forearm, anterior view, left side",
        "Deep muscles of the forearm, anterior view, left side"
      ],
      "sourceLabels": [
        "Pronator teres"
      ],
    ...
    {
      "id": "muscle-atlas-extensor-carpi-radialis-longus",
    ...
    {
      "id": "muscle-atlas-extensor-carpi-radialis-brevis",
    ...
    {
      "id": "muscle-atlas-extensor-digitorum",
    ...
    {
      "id": "muscle-atlas-flexor-digitorum-superficialis",
    ...
    {
      "id": "muscle-atlas-extensor-carpi-ulnaris",
    ...
    {
      "id": "muscle-atlas-flexor-carpi-ulnaris",
    ...
    {
      "id": "muscle-atlas-flexor-carpi-radialis",
    ...
    {
      "id": "muscle-atlas-palmaris-longus",
    ...
    {
      "id": "muscle-atlas-flexor-digitorum-profundus",
    ...
    {
      "id": "muscle-atlas-biceps-brachii-long-head",
    ...
    {
      "id": "muscle-atlas-biceps-brachii-short-head",
    ...
    {
      "id": "muscle-atlas-triceps-brachii-medial-head",
    ...
    {
      "id": "muscle-atlas-triceps-brachii-long-head",
    ...
    {
      "id": "muscle-atlas-triceps-brachii-lateral-head",
  ...
  "muscleVisualLookup": {
    ...
    "Levator scapulae": "muscle-atlas-levator-scapulae",
    "Rhomboid minor": "muscle-atlas-rhomboid-minor",
    "Rhomboid major": "muscle-atlas-rhomboid-major",
    "Subclavius": "muscle-atlas-subclavius",
    "Pectoralis minor": "muscle-atlas-pectoralis-minor",
    "Serratus anterior": "muscle-atlas-serratus-anterior",
    "Supraspinatus": "muscle-atlas-supraspinatus",
    "Teres minor": "muscle-atlas-teres-minor",
    "Infraspinatus": "muscle-atlas-infraspinatus",
    "Subscapularis": "muscle-atlas-subscapularis",
    "Deltoid": "muscle-atlas-deltoid",
    "Pectoralis major": "muscle-atlas-pectoralis-major",
    "Triceps brachii": "muscle-atlas-triceps-brachii",
    "Teres major": "muscle-atlas-teres-major",
    "Latissimus dorsi": "muscle-atlas-latissimus-dorsi",
    "Biceps brachii": "muscle-atlas-biceps-brachii",
    "Brachialis": "muscle-atlas-brachialis",
    "Brachioradialis": "muscle-atlas-brachioradialis",
    "Pronator teres": "muscle-atlas-pronator-teres",
    "Extensor carpi radialis longus": "muscle-atlas-extensor-carpi-radialis-longus",
    "Extensor carpi radialis brevis": "muscle-atlas-extensor-carpi-radialis-brevis",
    "Extensor digitorum": "muscle-atlas-extensor-digitorum",
    "Flexor digitorum superficialis": "muscle-atlas-flexor-digitorum-superficialis",
    "Extensor carpi ulnaris": "muscle-atlas-extensor-carpi-ulnaris",
    "Flexor carpi ulnaris": "muscle-atlas-flexor-carpi-ulnaris",
    "Flexor carpi radialis": "muscle-atlas-flexor-carpi-radialis",
    "Palmaris longus": "muscle-atlas-palmaris-longus",
    "Flexor digitorum profundus": "muscle-atlas-flexor-digitorum-profundus",
    "Biceps brachii - long head": "muscle-atlas-biceps-brachii-long-head",
    "Biceps brachii - short head": "muscle-atlas-biceps-brachii-short-head",
    "Triceps brachii - medial head": "muscle-atlas-triceps-brachii-medial-head",
    "Triceps brachii - long head": "muscle-atlas-triceps-brachii-long-head",
    "Triceps brachii - lateral head": "muscle-atlas-triceps-brachii-lateral-head"
  },
  "practiceCards": [
    {
  ...
  "stats": {
    ...
    "visualCards": 34,
    "focusedViews": 92,
    "practiceSetsAdded": 14,
    "missingTerms": [
      "Pronator quadratus"
    ],
    "genericFallbackTerms": [
  ...
  data.practicalLabelingCards = [...oldPractice, ...bundle.practiceCards];

  data.muscles = (data.muscles || []).map((muscle) => {
    const name = muscle.muscle || muscle.name || muscle.label;
    const image = data.muscleImageLookup[name];
    const visualId = data.muscleVisualLookup[name];
    return image ? { ...muscle, image, visualId } : muscle;
  });
  data.modelKey = (data.modelKey || []).map((entry) => {
    const name = typeof entry.item === 'string' ? entry.item : '';
    const image = data.muscleImageLookup[name];
    const visualId = data.muscleVisualLookup[name];
    return image ? { ...entry, image, visualId } : entry;
  });
  data.practicalModelFocus = (data.practicalModelFocus || []).map((entry) => {
    const name = typeof entry === 'string'
      ? entry
      : (entry.item || entry.muscle || entry.label || '');
    const image = data.muscleImageLookup[name];
    const visualId = data.muscleVisualLookup[name];
    return (image && typeof entry === 'object') ? { ...entry, image, visualId } : entry;
  });
})();
